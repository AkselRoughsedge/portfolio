...
const ShowTracker = () => {
    ...
    return (
        <Page>
           ...
           subTitle3={[<div className="github-link"><img className="github-img" src={Github}></img><a color="white" href="https://github.com/sylviaah/netflixnchill-front-end" target="_blank" rel="noreferrer">GitHub Link</a></div>]}
