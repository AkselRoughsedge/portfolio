        ...
        <Page>
            <div>
                <div style={{marginTop:126}}>
                    <h1 className='h1-w-montserrat'>0Footprint</h1>
                    <SubTitleCont>
                        <h3 className='h3-w-montserrat'>Jan. 2022 - Aug 2022</h3>
                        <h3 className='h3-w-montserrat'>Front-end Developer</h3>
                    </SubTitleCont> 
                </div>
